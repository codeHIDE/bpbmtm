	...
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<script type="text/javascript">
			...
			$("#save").mouseover(function(){
				...
				var cardBackImg=$("#cardBackImg").val();
				a[0]=headImg;
				a[1]=hallImg;
				a[2]=otherImg1;
				a[3]=otherImg2;
				...
				if(idCardBackImg!=null && idCardBackImg!=''){
					$("#idCardBackImgFile").val(idCardBackImg);
				}
				...
				if(cardBackImg!=null && cardBackImg!=''){
					$("#cardBackImgFile").val(cardBackImg);
				}
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td style="text-align: left">
								<input type="file" name="file" class="inputext_style"
									id="idCardBackImg" />
								<input type="hidden" name="idCardBackImgFile" id="idCardBackImgFile" />
							</td>
						</tr>
						<tr>
							<td style="text-align: right">
						...
						<tr>
							...
							<td style="text-align: left">
								<input type="file" name="file" class="inputext_style"
									id="cardBackImg" />
								<input type="hidden" name="cardBackImgFile" id="cardBackImgFile" />
							</td>
						</tr>
						<tr>
