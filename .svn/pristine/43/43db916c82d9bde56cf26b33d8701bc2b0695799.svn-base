...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
           	   ...
           	   function f_search()
        {
           ...
           { display: '厂商编号', name: 'factoryNo', width: '12%' ,align: 'center' },
            { display: '厂商名称', name: 'factoryName', width: '12%', align: 'center' },
           ...
           { display: '操作', name: 'null', width: '10%', align: 'center' ,render: function (rowdata, rowindex, value)
               ...
               rownumbers:true,
                ...
                dataAciton : 'server',    
                url:'<s:url value="/factoryCode!selectFactoryCodeList.ac"/>'                           
            });
           ...
           function addWindow(){
            $.ligerDialog.open({ url: '<s:url value="/factoryCode!goToInsertFactoryCode.ac"/>',
        	...
        	if(yes){
        		$.post('<s:url value='/factoryCode!delectFactory.ac'/>',
				  {
				  		 id:id
				  },
				  function(data){
	...
	<form id="form1" action="<s:url value="/pages/codePage/factoryCodeList.jsp"/>" method="post">
				<table width="80%">
				</table>
			</form>
