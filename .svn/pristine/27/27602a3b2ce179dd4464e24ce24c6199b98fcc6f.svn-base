				...
				window.parent.$.ligerDialog.confirm('是否要保存信息?', function (yes) {
					if(yes){
						...
						$.ajax({
		                    type: "POST",
		                    dataType: "html",
		                    url: '<s:url value="/factoryRisk!insertFactoryRisk.ac"/>',
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="text-align: left;" width="120px">
								<input type="text" name="factoryRisk.factoryNo" id="factoryNo" />
						...
						<tr>
							...
							<td>
								<input type="text" name="factoryRisk.terminalCardQuota" id="terminalCardQuota" /> 元
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">
							...
							<td>
								<input type="text" name="factoryRisk.perCardQuota" id="perCardQuota" /> 元
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">
							...
							<td>
								<input type="text" name="factoryRisk.lowsetMentionAmt" id="lowsetMentionAmt" /> 元
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">
							...
							<td>
								<input type="text" name="factoryRisk.highestMentionAmt" id="highestMentionAmt" /> 元
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">
							...
							<td>
								<input type="text" name="factoryRisk.reserved1" id="reserved1" />元
							</td>
						</tr>
						<tr>
