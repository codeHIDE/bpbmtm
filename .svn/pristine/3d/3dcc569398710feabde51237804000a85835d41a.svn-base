	...
	<head>
		...
		<script type="text/javascript">
	        function initRights(busMerId){
		       	$.post("<s:url value='/merManager!allotRight.ac'/>",
		       	{    
		       		busMerId:busMerId	
		       	},
		    	function(json){
	       	...
	       	function addRight(mid){
	    		...
	    		if(rightStr.length<1){
	    			...
	    			$.post("<s:url value='/merManager!addAdmin.ac'/>",
					{
						busMerId:mid,
					...
					<table width="96%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="text-align: left;" width="120px">
								<input type="text" name="merManager.mmAccount" id="mmAccount" />
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="password"  name="merManager.mmPass" id="mmPass"  autocomplete="off"/>
							</td>
						</tr>
					</table>
					<h4>
