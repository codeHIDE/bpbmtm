...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
    	$(function(){
           ...
           { display: '操作', name: 'null', width: '10%', align: 'center' ,render: function (rowdata, rowindex, value)
           	 	{
           	 		var h = "";
           	 		<c:if test="${purview['4081'] == '4081'}">
              		 	h = "<a onclick='downloadDf("+rowdata.settleDate+")' style='cursor:pointer;color:blue;'>下载</a> ";
              		</c:if>
                    return h;
                }}
               ],  
               rownumbers:true,
                ...
                dataAciton : 'server',    
                url:'<s:url value="/MerSettleStatictis!dfList.ac"/>?settleType=1&settleDate='+$("#settleDate").val()                           
            });
           ...
           function f_search()
        {
           $("#form1").submit();
              ...
              function downloadDf(settleDate){
		  		location.href = '<s:url value="/MerSettleStatictis!downloadDf.ac"/>?settleDate='+settleDate+'&settleType=1';
       		 }
	...
	<body style="padding: 0px; overflow: hidden;"> 
		...
		<div id="searchbar">			
			<form id="form1" action="<s:url value="/pages/theReport/T1Report.jsp" />" method="post">
				<table width="80%">
					<tr>
