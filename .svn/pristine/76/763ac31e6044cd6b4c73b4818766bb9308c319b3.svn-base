...
<script type="text/javascript">
	...
	function initRight() {
		var getType = '';
		$.get("<s:url value='/merchantInfo!getPlatRightList.ac'/>", {
			account : getType
		}, function(json) {
			strObj = eval(json);
			var data = [];
	...
	<div id="content">
		...
		<div class="box_system">
			<form action="<s:url value="/merchantInfo!addManager.ac"/>"
				...
				<input type="hidden" value="" name="merManager.purview"  id="check" />
					<input type="hidden" value="<s:property value="merManager.mid"/>" name="merManager.mid" id="check" />
				<table  style="text-align: center;" width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="120px" style="text-align: right;">登录名：</td>
						<td style="text-align: left;" width="120px"><input type="text" name="merManager.loginName" id="loginName" value="<s:property value="merManager.loginName"/>" /></td>
						<td width="120px" style="text-align: right;" >操作员姓名：</td>
						<td style="text-align: left;" width="120px"><input type="text" name="merManager.realName" id="realName" value="<s:property value="merManager.realName"/>" /></td>
					</tr>
					<tr>
						<td style="text-align: right;">登录密码：</td>
						<td><input type="password" value="<s:property value="merManager.loginPwd"/>" name="merManager.loginPwd" id="loginPwd" /></td>
						<td style="text-align: right;">确认密码：</td>
						<td><input type="password" value="" name="reloginPwd" id="reloginPwd" /></td>
					</tr>
					<tr>
						<td width="120px" style="text-align: right;">手机号：</td>
						<td style="text-align: left;" width="120px"><input type="text" name="merManager.phone" id="phone" value="<s:property value="merManager.phone"/>" /></td>
						<td style="text-align: right;">邮箱：</td>
						<td><input type="text" value="<s:property value="merManager.email"/>" name="merManager.email" id="email" /></td>
					</tr>
					<tr>
