...
public class MerTerminalInfoDaoImpl implements MerTerminalInfoDao{
	...
	@Override
	public MerTerminalInfo selectMerTerminalVersion(MerTerminalInfo merTerminalInfo) {
		return (MerTerminalInfo) sqlSessionTemplate.selectOne("selectMerTerminalVersion", merTerminalInfo);
	}
