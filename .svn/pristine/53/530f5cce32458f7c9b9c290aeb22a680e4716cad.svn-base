...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var flag = false;
		function saveInfo(){
		if(len("payBankName","30","EandS","通道名")&&len("payBankId","20","EN","通道ID")){
				window.parent.$.ligerDialog.confirm('是否要保存信息?', function (yes) {
					if(yes){
						...
						$.ajax({
		                    type: "POST",
		                    dataType: "html",
		                    url: '<s:url value="/payBankCode!insertpayBankCode.ac"/>',
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="text-align: left;" width="120px">
								<input type="text" name="payBankCode.payBankName" id="payBankName" />
						...
						<tr>
							...
							<td>
								<input type="text" name="payBankCode.payBankId" id="payBankId" />
							</td>
						</tr>
						<tr>
