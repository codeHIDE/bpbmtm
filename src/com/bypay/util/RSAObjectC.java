...
public class RSAObjectC {
	...
	public void loadPublicKey(String publicKeyStr) throws Exception{
		try {
			System.out.println("公钥：#"+new String(Base64.encodeBase64(publicKeyStr.getBytes("UTF-8")),"UTF-8"));
	...
	public void loadPrivateKey(String privateKeyStr) throws Exception{
		try {
			System.out.println("私钥：#"+new String(Base64.encodeBase64(privateKeyStr.getBytes("UTF-8")),"UTF-8"));
			BASE64Decoder base64Decoder= new BASE64Decoder();
	...
	public static void main(String[] args){
		...
		try {
			...
			System.out.println(RSAObjectC.byteArrayToString(cipher));
			System.out.println("明文长度:"+ plainText.length);
			System.out.println(RSAObjectC.byteArrayToString(plainText));
