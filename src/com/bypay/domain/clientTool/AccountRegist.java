...
public class AccountRegist extends BeanParent {
	...
	@XmlElement
	private String subMerAddress;		//子商户地址
	...
	public String getSubMerAddress() {
		return subMerAddress;
	}
	public void setSubMerAddress(String subMerAddress) {
		this.subMerAddress = subMerAddress;
	}
