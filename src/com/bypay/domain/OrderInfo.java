...
public class OrderInfo extends BaseExcel implements java.io.Serializable {
	...
	private String agentIdL3; // 二级代理商号
	private String agentIdL4; // 二级代理商号
	private String agentIdL5; // 二级代理商号
	private String agentIdL6; // 二级代理商号
	private String agentIdL7; // 二级代理商号
	private String agentIdL8; // 二级代理商号
	private String agentIdL9; // 二级代理商号
	private String agentIdL10; // 二级代理商号
	...
	private int settleStatus;		//是否已代付标识	 1代付成功 2冲正成功3冲正失败 4.96T 5.代付中
...
//	private SubMerTerminal subMerTerminal;
	...
	private String transMerName;		//通道名
	private OrderProfit orderProfit;
