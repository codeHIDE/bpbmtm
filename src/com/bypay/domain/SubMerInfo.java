...
public class SubMerInfo {
	...
	private String agentIdL5; // 代理商号(外键) AGENT_ID_L2
	private String agentIdL6; // 代理商号(外键) AGENT_ID_L2
	private String agentIdL7; // 代理商号(外键) AGENT_ID_L2
	private String agentIdL8; // 代理商号(外键) AGENT_ID_L2
	private String agentIdL9; // 代理商号(外键) AGENT_ID_L2
	private String agentIdL10; // 代理商号(外键) AGENT_ID_L2
	...
	private String scanTsn;

	public String getScanTsn() {
        return scanTsn;
    }

    public void setScanTsn(String scanTsn) {
        this.scanTsn = scanTsn;
    }
