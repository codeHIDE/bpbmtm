...
* @author Eason Jiang 
* @date 2016-5-31 下午5:40:32 
*
 */
public class ZyClear {
	//私钥是假的
...
//	public static String publicKey="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDEt4xl7lP9v5R4Kd3Hd9n+5jgdbtQApkPiM6OrCPH1bGZ6aTr1qTR/VCfiiP38HVlVU9IVuJss2U1Zt6Kxaf6CV7GeenX8bvagWdE9BElw6iAKlfxYBIAlTVsIrjqtfExzSN4Z1C4iHI+2+ELkIry63n2JlJj/rhOq/c4BHB8DpQIDAQAB";
	public static String publicKey  ="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDGxA/u74LjUEDn6us+D62znikkfe73gA1yz9nMBVMZVCUi1TbczINpIamNjgYkKIGP95VzhrO8TWB46MUD/N6kfk+LSMrjcRoNCCBWZEd3PD6vJo1gr9pJkr1kDPHg/yaM0vK5lMg7h+y+hVgW/byH4aA80Z6Qpn1fHb1muY/kNwIDAQAB";
//	public static String publicKey2="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDGxA/u74LjUEDn6us+D62znikkfe73gA1yz9nMBVMZVCUi1TbczINpIamNjgYkKIGP95VzhrO8TWB46MUD/N6kfk+LSMrjcRoNCCBWZEd3PD6vJo1gr9pJkr1kDPHg/yaM0vK5lMg7h+y+hVgW/byH4aA80Z6Qpn1fHb1muY/kNwIDAQAB";
...
//	public static String tcode = "60110";
	public static String mcode = "137458150713099";
	public static String t0mcode = "137458150817029";			//t0商户
	public static String tcode = "60110";
	public static String t0code = "60032";									//T0终端
	...
	public static void main(String args[]){
		try {
			...
			result.put("mcode", t0mcode);
			result.put("tcode", t0code);
...
//			String track2Data = "6215581111004500898d25032200299991917";
			...
			Date date = new Date();
//			代付
			result.put("action","issOrder_pay");
			...
			result.put("userName", "李奕");
			result.put("bankCard", "6215581111004500898");
			result.put("openingBank", "工商银行");
			result.put("bbankProvince", "江苏省");
			result.put("bbankCity", "南通市");
			result.put("branchesBank", "南通分行业务处理中心");
			result.put("branchesBankCode", "102306082007");
			result.put("transMoney", "997");
...
//			diaoyong(s);
	 ...
	 * @throws 
	 * @author        Eason Jiang
	 * @Date          2016-6-1 上午10:48:37
	 */
	public  CoreTransInfo zyClear(CoreTransInfo coreTransInfo){
		try {
			Map<String,Object> result = new LinkedHashMap<String,Object>();
			result.put("mcode", t0mcode);
			result.put("tcode", t0code);
...
//			代付
			...
			result.put("merchantOrderId", TimeUtils.dateString(date, "yyyyMMddHHmmssSSS"));
			result.put("merchantOrderTime", TimeUtils.dateString(date, "yyyyMMddHHmmss"));			
			result.put("userName", coreTransInfo.getUserName());
			result.put("bankCard", coreTransInfo.getPan());
			result.put("openingBank", "工商银行");
			result.put("bbankProvince", "江苏省");
			result.put("bbankCity", "南通市");
			result.put("branchesBank", coreTransInfo.getUserDefined2());
			result.put("branchesBankCode", coreTransInfo.getUserDefined3());
			result.put("transMoney", coreTransInfo.getAmount());
...
//			result.put("mobile", mobile);
			...
			JSONObject json = diaoyong(JSONStringBuilder.getAjaxString(result));
			if(json!=null && json.getString("reqCode").equals("0000")){
				coreTransInfo.setResponseCode("00");
			}else{
				coreTransInfo.setResponseCode(json.getString("reqCode"));
				coreTransInfo.setResponseDesc(json.getString("reqMsg"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static JSONObject diaoyong(String json)throws Exception{
		String terminalTypeId = new String(Base64.encodeBase64(t0mcode.getBytes("UTF-8")),"UTF-8");
...
//		String urlStr = "http://www.zytlpay.com:8600/zyPayInfo/forward/fcn.action";
		String urlStr = "http://clinfo.zytlpay.com/zyClearInfo/forward/fcn.action";
