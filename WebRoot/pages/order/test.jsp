...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    function sub(){
    		...
    		var formData=
				{
					testTime : $("#userName").val()
				};
			var url = "<s:url value='/orderInfo!testPay.ac'/>";
...
#alert p input.sub {width:60px;margin-left:30px;} 
  ...
  <body style="text-align: center;">
 		...
 		<b style="font-size:20px;">代付测试</b><br/><br/>
 		</div>
   	<table width="100%" style="text-align: center;" border="0">
   		<tr>
   			<td style="text-align: right;">测试次数:</td>
   	...
   	<br />
   	<div>
		<input type="button" value="代付测试" class="l-button" onclick="sub()"/> 
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 
