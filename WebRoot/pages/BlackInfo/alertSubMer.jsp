	...
	<head>
		...
		<script type="text/javascript">
			function submitTsn(){
				...
				if(alertType.value == "" || alertType.value == null){
					$.ligerDialog.warn("请选择提示方式");
					alertType.focus();
					return false;
				}
				...
				$.ligerDialog.confirm('是否修改?', function (yes) { 
					if(yes){
						var formData=
				{
				...
				var url = "<s:url value='/blackInfo!alertSubMer.ac'/>";
	...
	<body style="padding: 4px; overflow: hidden;">
		...
		<tr>
			<td colspan="2" align="center">
				<br />
				<select name="alertType" id="alertType" ltype="select"  >
					<option value="">---请选择---</option>
					<option value="1">商户号提醒</option>
					<option value="2">交易地址提醒</option>
				</select>
				<textarea id="subMerId" name="subMerId" rows="20" cols="60"></textarea>
				<input type="button" value="修改商户" class="l-button" onclick="submitTsn()"/>
				<br />
			</td>
		</tr>
		<tr>
