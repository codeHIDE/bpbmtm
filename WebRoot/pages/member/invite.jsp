...
<body>
<div id="particles" style="background: url('images/back.png') no-repeat  bottom ">
   <div class="intro" style="margin-top: -256.5px;">
    <div class="container">
      <div class="row" style="padding:30px 0;">
        <div class="col-md-3 col-centered tac"> <img src="images/108logo.png" alt="logo" align="middle"> </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
            ...
            <div class="form-group">
            	<table >
            		<tr> 
            				...
            				<td>
            				<input type="text" class="form-control" id="username" name="username"  placeholder="手机号" autocomplete="off" aria-required="true" data-tip="11位手机号"  style="width:220px; "/>
            				</td>
            		</tr>
            		<tr>
            				<td>
            				  <img src="images/password.png" style="float:left;"/>
            				</td>
            				<td>
            					<input type="password" class="form-control" id="password" name="password" placeholder="密码" aria-required="true" data-tip="请设置您的密码" style="width:220px; "/>
            				</td>
            		</tr>
            		<tr>
            				<td>
            					<img src="images/password2.png" style="float:left;"/>
            				</td>
            				<td>
            					 <input type="password" class="form-control" id="passwordAgain" name="passwordAgain" placeholder="再次输入密码" aria-required="true" data-tip="请再输入一次密码" style="width:220px; "/>
            				</td>
            		</tr>
            		<tr>
            				<td>
            					<img src="images/checkcode.png" style="float:left;"/>
            				</td>
            				<td>
            					<input type="text"  class="form-control"  id="checkCode" name="checkCode" placeholder="验证码"  aria-required="true"  style="width:120px; float:left;" />
