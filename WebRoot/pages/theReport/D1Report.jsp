...
<html xmlns="http://www.w3.org/1999/xhtml">
    	...
    	$(function(){
           ...
           { display: '操作', name: 'null', width: '10%', align: 'center' ,render: function (rowdata, rowindex, value)
               ...
               rownumbers:true,
                ...
                dataAciton : 'server',    
                url:'<s:url value="/MerSettleStatictis!dfList.ac"/>?settleType=0&settleDate='+$("#settleDate").val()                           
            });
           ...
           function f_search()
        {
           $("#form1").submit();
             ...
             function downloadDf(settleDate){
		  		location.href = '<s:url value="/MerSettleStatictis!downloadDf.ac"/>?settleDate='+settleDate+'&settleType=0';
       		 }
	...
	<body style="padding: 0px; overflow: hidden;"> 
		...
		<div id="searchbar">			
			<form id="form1" action="<s:url value="/pages/theReport/D1Report.jsp" />" method="post">
				<table width="80%">
					<tr>
