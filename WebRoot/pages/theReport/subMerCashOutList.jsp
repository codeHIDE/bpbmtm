...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        function f_download(settleDate){
		  		location.href = '<s:url value="/MerSettleStatictis!subMerExcel.ac"/>?createDate2='+$("#createDate").val();
        }
    </script>
	</head>
			...
			<form id="form1" action="<s:url value="/pages/theReport/subMerCashOutList.jsp" />" method="post">
				<table width="80%">
					<tr>
						...
						<td style="text-align: left;"><input id="btn3" type="button" value="下 载" onclick="f_download()" class="l-button"/></td>
					</tr>
				</table>
			</form>
		</div>
