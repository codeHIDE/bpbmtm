		...
		<div id="content">
			...
			<div class="box_system">
						...
						<tr>
							...
							<td>
								<s:if test="tractInfo.tractFlag==1">大额通道</s:if>
								<s:if test="tractInfo.tractFlag==0">小额通道</s:if>
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">
					...
					<td width="150px" style="text-align: right;">
						...
						<tr>
							...
							<td>
								...
								<s:else>
								<fmt:formatNumber  value="${tractInfo.bypayProfit/100}" type="number" pattern="0.0000" /> 元</s:else>
							</td>
						</tr>
						<tr>
						<td width="120px" style="text-align: right;">
						...
						<td width="120px" style="text-align: right;">
							...
							<td>
								<s:if test="tractInfo.payMerId==''">未填写</s:if>
								<s:else><s:property value="tractInfo.payMerId"/></s:else>
							</td>
						<td width="120px" style="text-align: right;">
								代付终端号：
							</td>
							<td>
								<s:if test="tractInfo.payTerId==''">未填写</s:if>
								<s:else><s:property value="tractInfo.payTerId"/></s:else>
							</td>
						</tr>
							<tr>
