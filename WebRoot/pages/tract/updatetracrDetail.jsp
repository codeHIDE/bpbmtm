					...
					<td style="text-align: right;">
						...
						<td>
							<select name="tractInfo.ratesType" id="ratesType"  onchange="change(this.value);">
									...
									<option value="17" <s:if test="tractInfo.ratesType==17" > selected="selected"</s:if>>
										通道直付
									</option>
									<option value="31" <s:if test="tractInfo.ratesType==31" > selected="selected"</s:if>>
										香港(境外)
									</option>
									<option value="32" <s:if test="tractInfo.ratesType==32" > selected="selected"</s:if>>
										英国(境外)
									</option>
									<option value="33" <s:if test="tractInfo.ratesType==33" > selected="selected"</s:if>>
										美国(境外)
									</option>
									<option value="34" <s:if test="tractInfo.ratesType==34" > selected="selected"</s:if>>
										法国(境外)
									</option>
									<option value="35" <s:if test="tractInfo.ratesType==35" > selected="selected"</s:if>>
										日本(境外)
									</option>
									<option value="36" <s:if test="tractInfo.ratesType==36" > selected="selected"</s:if>>
										新西兰(境外)
									</option>
									<option value="37" <s:if test="tractInfo.ratesType==37" > selected="selected"</s:if>>
										马来西亚(境外)
									</option>
									<option value="38" <s:if test="tractInfo.ratesType==38" > selected="selected"</s:if>>
										泰国(境外)
									</option>
								</select>
						</td>
