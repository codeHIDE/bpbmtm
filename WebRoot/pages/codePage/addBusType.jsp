				...
				window.parent.$.ligerDialog.confirm('是否要保存信息?', function (yes) {
					if(yes){
						...
						$.ajax({
		                    type: "POST",
		                    dataType: "html",
		                    url: '<s:url value="/busType!addBusType.ac"/>',
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="text-align: left;" width="120px">
								<input type="text" name="busType.busId" id="busId" />
						...
						<tr>
							...
							<td>
								<input type="text" name="busType.busName" id="busName" />
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">
							...
							<td>
								<input type="text" name="busType.busDesc" id="busDesc" />
							</td>
						</tr>
						<tr>
							<td style="text-align: right;">
							...
							<td>
								<input type="text" name="busType.remark" id="remark" />
							</td>
						</tr>
						<!-- 
						<tr>
							...
							<td>
								<input type="text" name="busType.type" id="type" />
							</td>
						</tr>
						 -->
						<tr>
