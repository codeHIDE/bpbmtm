			...
			function saveMer(){
				...
				if(yes){
					...
					$.ajax({
		                   type: "POST",
		                   dataType: "html",
		                   url: '<s:url value="/channel!addChannelMerInfo.ac"/>',
					...
					<table width="80%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<div class="l-text" style="width: 200px;">
								<input  class="l-text-field" style="width:200px" type="text" name="channelMerInfo.chName" type="text" id="chName" />
							</div>
							</td>
							<td style="text-align: right;">
								渠道商户号：
							...
							<td>
							<div class="l-text" style="width: 200px;">
								<input type="text" class="l-text-field" style="width:200px" name="channelMerInfo.chMerId" id="chMerId" />
							</div>
							</td>
						</tr>
						<tr>
							...
							<div class="l-text" style="width: 200px;">
								<input type="text" class="l-text-field" style="width:200px"
									name="channelMerInfo.chTermId" id="chTermId" />
							</div>
							</td>
							<td style="text-align: right;">
								渠道序列号：
							...
							<div class="l-text" style="width: 200px;">
								<input type="text" class="l-text-field" style="width:200px"
									name="channelMerInfo.chSeriId" id="chSeriId" />
									</div>
							</td>
						</tr>
						<tr>
							...
							<div class="l-text" style="width: 200px;">
								<input type="text" class="l-text-field" style="width:200px"
									name="channelMerInfo.chZMK" id="chZMK" />
									</div>
							</td>
						...
						<td>
							...
							<select name="channelMerInfo.rateType" id="rateType"  style="width: 200px"  class="l-text-field" >
								<option value="00"
								<c:if test="${param.orderRateType==00}">selected="selected"</c:if>>
								普通消费</option>
								<option value="31"
						...
						<tr>
							...
							<td>
							<div class="l-text" style="width: 200px;">
								<input  class="l-text-field" style="width:200px" type="text" name="channelMerInfo.t0Fee" type="text" id="t0Fee" />元
							</div>
							</td>
							<td style="text-align: right;">
								T0费率：
							...
							<td>
							<div class="l-text" style="width: 200px;">
								<input type="text" class="l-text-field" style="width:200px" name="channelMerInfo.t0Rate" id="t0Rate" />
							</div>
							</td>
						</tr>
						<tr>
							<td style="text-align:center" colspan="4">
								<input type="button" value="保存" id="btn" onclick="saveMer()" style="width:80px;"/>
							</td>
						</tr>
					</table>
				</form>
